				...
				<% if(((List<Goods>)request.getAttribute("gs")).size()==0){
					...
					<ul class="clearfix">
						...
						<li style="margin-right: 8px">
							...
							<div class="show">
								<--<a class="add" href="car/add?pid=<%=g.getgoods_id()%>">加入购物车</a>
								<a class="contrast" href="fav/delete?pid=<%=g.getgoods_id()%>">移除到收藏夹</a>-->
							</div>
							<div class="proImg">
								<a href="#"> <img class="lazy" src="<%=g.getimage()%>"
									data-original="<%=g.getimage()%>" alt="">
								</a>
							</div>
							<div class="proTxt">
								<p>

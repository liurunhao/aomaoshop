...
<%@page import="com.oracle.shop.model.javabean.shoppingcart"%>
...
<!-- 				<span class="tax">保税仓发货</span> -->
			...
			<ul class="IAbdArea">
				...
				<li class="IAbdw">
					...
					<input type="checkbox"  name="pid" value="<%=c.getgoods_id()%>"/>
					<img src="<%=c.getimage() %>" alt="">
					<p>
						<a class="pro" href="#"><%=c.getgname() %></a>
<!-- 						<a class="use" href="#"> -->
<!-- 							适用税率：10% -->
<!-- 							<s></s> -->
<!-- 							<u> -->
...
<!-- 						</a> -->
					...
					<ul class="IAul">
						...
						<li class="last btn">
							<a>移入收藏夹</a><br>
							<a class="delet" href="javascript:if(window.confirm('确认删除这个商品么')){location.href='car/delete?pid=<%=c.getgoods_id() %>'}">删除</a>
						</li>
					</ul>
				</li>
			...
			<div class="account">
				<ul>
					<li>收货人:<input type="text" name="shouhuoname" style="height: 25px;font-size: 14px;box-shadow:0px 0px 3px orange"/></li>
					<li>收货地址:<input type="text" name="adresses" style="height: 25px;font-size: 14px;width: 400px;box-shadow:0px 0px 3px orange"/></li>
					<li>备注:<input type="text" name="mark" style="height: 25px;font-size: 14px;width: 400px;box-shadow:0px 0px 3px orange"/></li>
				</ul>
			</div>
			<div class="IAbdfoot">
